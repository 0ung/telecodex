...
run_root chown root:root "$WORKER_CONFIG_PATH" "$GATEWAY_CONFIG_PATH" "$WORKER_ENV_PATH" "$GATEWAY_ENV_PATH"
run_root chmod 644 "$WORKER_CONFIG_PATH" "$GATEWAY_CONFIG_PATH"
